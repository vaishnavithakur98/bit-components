...
const CreatedField = ({ field, actionHandler, index }) => {
  ...
  return (
    <div className={`form-group ${config.inputClasses}`}>
      <div className="d-flex justify-content-between align-items-start pb-2">
        ...
        <span>
          <button
            ...
            type="button"
            onClick={() => actionHandler("settings", index)}
          >
            <i className="fa fa-wrench" />
          </button>

          <button
            className="btn btn-light text-danger btn-sm ml-3"
            type="button"
